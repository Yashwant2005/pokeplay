function register_067_vitamin(bot, deps) {
  ...
  function buildStatKeyboard(pass, id) {
    return [
      [
        { text: 'HP', callback_data: 'vitye-hp-' + pass + '-' + id },
        { text: 'Attack', callback_data: 'vitye-attack-' + pass + '-' + id },
        { text: 'Defense', callback_data: 'vitye-defense-' + pass + '-' + id }
      ],
      [
        { text: 'SpA', callback_data: 'vitye-special_attack-' + pass + '-' + id },
        { text: 'SpD', callback_data: 'vitye-special_defense-' + pass + '-' + id },
        { text: 'Speed', callback_data: 'vitye-speed-' + pass + '-' + id }
      ]
    ]
  }
