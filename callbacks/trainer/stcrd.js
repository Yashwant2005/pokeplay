...
const hasAvatarFile = fs.existsSync("./cimages/"+avr+".png") || fs.existsSync("./cimages2/"+avr+".png")
userData.inv.avtar = hasAvatarFile ? avr : "1"
...
if (p) {
  ...
  ctxCanvas.font = "bold 84px Arial";
...
module.exports = register_050_stcrd;
