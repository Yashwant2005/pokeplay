...
if ((!ext || ext!='pass') && userData.inv.vp < 100) {
  await editMessage('text',ctx,ctx.chat.id,ctx.callbackQuery.message.message_id,'Entry Fees Is *100 Victory Points ⚡*',{parse_mode:'markdown'});
    return;
  }
const regions = {
