      ...
      if (userData2.refers % 22 === 0) {
        ...
        if (poked) {
          ...
          if (moves) {
            ...
            const da = { name: pokeName, id: poked.pokedex_number, nature: nat, ability: getRandomAbilityForPokemon(pokeName, pokes), held_item: 'none', exp: exp, pass: pass2, ivs: iv, symbol: "", evs: ev, moves: ms };
