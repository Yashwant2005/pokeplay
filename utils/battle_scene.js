...
function applyBattleSceneMoveVisual(battleData, { moveName, pass, isZMove } = {}) {
  ...
  if (TERRAIN_MOVE_MAP[normalizedMove]) {
    sceneState.terrain = TERRAIN_MOVE_MAP[normalizedMove];
  }
  if (ROOM_MOVE_MAP[normalizedMove]) {
    sceneState.room = ROOM_MOVE_MAP[normalizedMove];
  }
